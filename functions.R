...
# of the following 30 functions:
# 
# - For Constructing Each Model:
#     BIBT.cpp, BIBT.R, BBT.cpp, BBT.R, BBT.Stan, BT.freq;
# - For Running MCMC:
#     run.MCMCs, plot.MCMCs, plot.posteriors, plot.ACFs, stats.posteriors, 
#     mcmc.extract, build.hodge_operators;
# - For Simulations:
...
# - For Visualization
#     plot.s, plot.relations, plot.networks, plot.reversed_edges, plot.Metrics1, 
#     plot.Metrics2, plot.vorticity.hist, plot.vorticity.forest
#
